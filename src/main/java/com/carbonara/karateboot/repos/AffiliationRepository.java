...
public interface AffiliationRepository extends JpaRepository<Affiliation, Integer>{
    ...
    public Iterable<Affiliation> findByDateBetween(Date startDate, Date endDate);
    public Affiliation findByTransactionCode(String code);
    public Iterable<Affiliation> findByDateBetweenAndClub(Date startDate, Date endDate,Club club);
}